...
```javascript
cbrtBy = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-cbrt-by@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/math-strided-special-cbrt-by/tags). For example,

```javascript
cbrtBy = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-cbrt-by@v0.0.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-cbrt-by@umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/math-strided-special-cbrt-by/actions/workflows/test.yml/badge.svg?branch=v0.0.1
[test-url]: https://github.com/stdlib-js/math-strided-special-cbrt-by/actions/workflows/test.yml?query=branch:v0.0.1
...
[@stdlib/math/base/special/cbrt]: https://github.com/stdlib-js/stdlib/tree/umd
